        ...
        {/* Start Footer */}
            ...
            <div className="container">
                ...
                <div className="col-lg-3 col-md-6">
                    ...
                    <li className="list-inline-item"><a href="#"><i class="fa fa-facebook"/></a></li>
                    <li className="list-inline-item"><a href="#"><i class="fa fa-twitter"/></a></li>
                    <li className="list-inline-item"><a href="#"><i class="fa fa-linkedin"/></a></li>
                    </ul>
                </div>
                <div className="col-lg-3 col-md-6">
            ...
            <div className="copyright">
                ...
                <div className="row">
                    ...
                    <p className="company-name">All Rights Reserved. © 2020 <a href="#">FEASTA</a></p>
                    </div>
                </div>
                </div>
            </div>
