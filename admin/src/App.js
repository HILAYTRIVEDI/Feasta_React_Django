      ...
      <li className="nav-item">
        ...
        <div id="collapseUtilities" className="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div className="bg-white py-2 collapse-inner rounded">
            ...
            <a className="collapse-item" href="utilities-other.html">Special Offer</a>
            <a className="collapse-item" href="utilities-other.html">Special Item</a>
          </div>
        </div>
      </li>
      {/* Divider */}
      ...
      <div id="content">
        ...
        <div className="container-fluid">
         <Switch>
          ...
          <Route path="/menu_updation"><MenuUpdation/></Route>
          <Route path="/add_category"><AddCategory/></Route>
